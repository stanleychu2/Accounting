...
//              guard let port: SMPort = SMPort.getPort(portName, "(your original portSettings);l1000)", 10000) else {
                ...
                _ = Communication.parseDoNotCheckCondition(parser, port: port, completionHandler: { (result: Bool, title: String, message: String) in
                    if result == true {
                        ...
                        self.showSimpleAlert(title: "Failure",
